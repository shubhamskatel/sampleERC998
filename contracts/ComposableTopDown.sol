    ...
    ERC998ERC20TopDownEnumerable
{
        ...
        returns (bytes32 rootOwner)
    {
        ...
        bool callSuccess;
        bytes memory calldataSample;
        // 0xed81cdda == rootOwnerOfChild(address,uint256)
        calldataSample = abi.encodeWithSelector(
            0xed81cdda,
            address(this),
            _childTokenId
        );
        assembly {
            callSuccess := staticcall(
                gas(),
                rootOwnerAddress,
                add(calldataSample, 0x20),
                mload(calldataSample),
                calldataSample,
                0x20
            )
            if callSuccess {
                rootOwner := mload(calldataSample)
            }
        }
    ...
    function _transferFrom(
        ...
        if (msg.sender != _from) {
            ...
            bool callSuccess;
            // 0xed81cdda == rootOwnerOfChild(address,uint256)
            bytes memory calldataSample = abi.encodeWithSelector(
                0xed81cdda,
                address(this),
                _tokenId
            );
    ...
    function transferERC20(
        ...
        require(
            ERC20AndERC223(_erc20Contract).transfer(_to, _value),
    ...
    function transferERC223(
        ...
        require(
            ERC20AndERC223(_erc223Contract).transfer(_to, _value, _data),
    ...
    function getERC20(
        ...
        if (!allowed) {
            ...
            assembly {
                ...
                if callSuccess {
                    remaining := mload(calldataSample)
                }
            }
        ...
        require(
            ERC20AndERC223(_erc20Contract).transferFrom(
                _from,
                address(this),
                _value
            ),
